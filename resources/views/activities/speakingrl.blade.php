...
<center>
<h4><i>You will hear a lecture. After listening to the lecture, in 10 seconds, please speak into the microphone and retell what you just heard from the lecture in your own words. You will have 40 seconds to give your response.</i></h4> <div class='w3-card-4 p-1' style='width:25%; background-color: white;'> <div class='w3-container'> <p class='card-text'>Status : <span id='SpeakingRecStatus'>Playing</span></p> <div class='w3-light-grey m-2'> <div id='listeningqbar' class='w3-green' style='height:24px;width:0'></div> </div> </div> </div> <div class='w3-card-4 p-1 mt-5' id="ans" style='width:25%; background-color: white;'> <h2>Record Answer</h2> <div class='w3-container'> <p class='card-text'>Status : <span id='SqrecStatus'>recording</span></p> <div class='w3-light-grey m-2'> <div id='sarbar' class='w3-green' style='height:24px;width:0'></div> </div> <button id='sasbtn' class='w3-button w3-ripple w3-red' disabled>Stop</button> </div> </div>
...
<form id="nextQues" action="{{route('srl')}}" method="POST">
	@csrf
