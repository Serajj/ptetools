...
<div class="container justify-content-center">
    <h4><i>You will hear a recording. Click on the paragraph that best relates to the recording.</i></h4> 
...
<form id="nextQues" action="{{route('lhcs')}}" method="POST">
	@csrf
