...
<div class="container justify-content-center">
    <h4><i>You will hear a recording. Type the missing words below in each blank space.</i></h4> 
...
<div class="row justify-content-center m-4">
    <textarea style="width: 80%;min-height:200px" id="question" ></textarea>
</div>

<div class="row justify-content-center">
    <label for="text" class="form-label">Write Missing Words below</label>
    <input type="text" id="txt" class="form-control md-6 sm-6 m-5"  placeholder="Start writing missing words here seperate by (,)">
</div>

<div class="row justify-content-center" id="control">
</div>

<form id="nextQues" action="{{route('lfitb')}}" method="POST">
	@csrf
